...
import (
	...
	"encoding/base64"
	"fmt"
	"github.com/Anveena/ezTools/ezCaptcha/ezCaptchaPB"
...
func startGRPCService() {
	listener, err := ezNetworking.ListenTCP(captchaConfig.GRPCPort, -1, -1)
	if err != nil {
		panic(err)
	}
...
func (s server) GetCaptcha(c context.Context, _ *ezCaptchaPB.EZCaptchaEmpty) (*ezCaptchaPB.EZCaptchaRsp, error) {
